    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildArticle("ARTICLE 4 — CONDITIONS D'ACCÈS ET INSCRIPTION", _article4),
          _buildArticle(
          ...
          _buildArticle('ARTICLE 8 — POSTES OUVERTS ET CANDIDATURES', _article8),
          _buildArticle('ARTICLE 9 — SERVICES DE MESSAGERIE INSTANTANÉE', _article9),
          _buildArticle(
            'ARTICLE 10 — RÈGLES DE COMPORTEMENT ET OBLIGATIONS DES UTILISATEURS',
            _article10,
          ),
          _buildArticle('ARTICLE 11 — PROTECTION DES DONNÉES PERSONNELLES', _article11),
          _buildArticle('ARTICLE 12 — FONCTIONNALITÉ DE CARTOGRAPHIE', _article12),
...
const _preambule = '''L'application mobile KOBETA, accessible sur les plateformes iOS et Android, est éditée et exploitée conjointement par deux personnes physiques agissant en qualité de co-éditeurs particuliers, ci-après désignés individuellement « l'Éditeur » ou collectivement « les Éditeurs » :

Co-éditeur 1 :
  • Nom et prénom : [Axel CO-ÉDITEUR 1]
  • Demeurant au : [ADRESSE CO-ÉDITEUR 1]
  • Contact : kobeta.app@gmail.com
...
const _article1 = [
  _TosSection(
    body: '''Au sens des présentes Conditions Générales d'Utilisation, on entend par :
...
const _article2 = [
  _TosSection(
    body: '''Les présentes Conditions Générales d'Utilisation ont pour objet de définir les modalités et conditions dans lesquelles les Éditeurs mettent à disposition des utilisateurs les services de l'Application, ainsi que les droits et obligations respectifs des parties.
...
const _article3 = [
  _TosSection(
    ...
    body: '''Conformément aux articles 1128 et suivants du Code civil relatifs à la formation du contrat, l'utilisation de l'Application est subordonnée à l'acceptation préalable, expresse et sans réserve des présentes CGU.
...
Cette acceptation est matérialisée par le cochage de la case « J'ai lu et j'accepte les Conditions Générales d'Utilisation » lors de la création du compte. Cette action vaut signature électronique au sens de l'article 1366 du Code civil et engage l'utilisateur de manière ferme et définitive.''',
  ...
  _TosSection(
    ...
    body: 'Les CGU acceptées sont conservées par les Éditeurs et peuvent être communiquées à l\'utilisateur sur demande. Elles constituent la loi des parties conformément à l\'article 1103 du Code civil.',
  ),
];
...
const _article5 = [
  ...
  _TosSection(
    ...
    body: '''En application de l'article 1242 du Code civil relatif à la responsabilité du fait des choses, et dans la mesure où les Éditeurs n'ont ni la garde, ni le contrôle des activités sportives pratiquées, les Éditeurs excluent expressément toute responsabilité pour tout accident, blessure, dommage corporel ou décès survenant :
...
const _article6 = [
  _TosSection(
    ...
    body: 'Les accords conclus entre équipes via la plateforme, notamment concernant la tenue d\'un match ou la réservation d\'un terrain, constituent des engagements contractuels directs entre les utilisateurs, auxquels les Éditeurs sont tiers au sens de l\'article 1199 du Code civil.',
  ),
  _TosSection(
    subtitle: '6.2 Exclusion de responsabilité financière',
    body: '''Les Éditeurs ne perçoivent aucune somme au titre de la réservation de terrains et ne sont parties à aucun contrat de réservation conclu entre un utilisateur et un centre sportif. En conséquence, les Éditeurs ne sauraient être tenus responsables :
  ...
  _TosSection(
    ...
    body: '''Sans que cela ne constitue une obligation de résultat de leur part, les Éditeurs s'engagent à mettre en œuvre les mécanismes suivants afin de limiter les désistements abusifs :
...
const _article9 = [
  _TosSection(
    ...
    body: '''L'Application propose deux services de messagerie instantanée distincts :
  ...
  _TosSection(
    ...
    body: 'Les Éditeurs se réservent le droit d\'accéder aux messages dans le cadre strict des opérations de modération faisant suite à un signalement d\'un utilisateur ou à une réquisition judiciaire. Cet accès est limité à la stricte nécessité et ne constitue pas une surveillance systématique des échanges.',
  ),
  _TosSection(
    subtitle: '9.4 Durée de conservation des messages',
    body: 'Les messages échangés via les services de messagerie de l\'Application sont conservés pour une durée de dix (10) jours à compter de leur envoi, après quoi ils sont automatiquement et irrémédiablement supprimés des serveurs des Éditeurs.\n\nCette durée de conservation est réduite à néant en cas de clôture du compte de l\'utilisateur, conformément à l\'article 16 des présentes CGU. Les Éditeurs ne sauraient être tenus responsables de la perte de messages découlant de l\'expiration de ce délai de conservation.\n\nL\'utilisateur est invité à noter que ses échanges ne sont pas archivés à des fins personnelles. Il lui appartient de conserver lui-même les informations importantes échangées via la messagerie.',
  ),
];
...
const _article10 = [
  _TosSection(
    ...
    body: 'Conformément aux dispositions de la loi n° 2004-575 du 21 juin 2004 et du Règlement (UE) 2022/2065 (DSA), chaque utilisateur s\'engage à utiliser l\'Application de manière licite, loyale et dans le respect des droits des tiers.',
  ),
  _TosSection(
    subtitle: '10.2 Comportements interdits',
    body: '''Sont expressément interdits sur la plateforme, sous peine de suspension ou de suppression immédiate du compte :
...
Concernant l'utilisation du service :
  ...
  _TosSection(
    ...
    body: 'Conformément aux obligations imposées aux plateformes par le DSA, les Éditeurs mettent en place un dispositif de signalement permettant à tout utilisateur de signaler un contenu ou un comportement contraire aux présentes CGU. Les Éditeurs s\'engagent à traiter les signalements dans un délai raisonnable.',
  ),
  _TosSection(
    subtitle: '10.4 Sanctions',
    body: 'En cas de manquement aux présentes obligations, les Éditeurs se réservent le droit de procéder, sans préavis ni indemnité, à la suspension temporaire ou à la suppression définitive du compte de l\'utilisateur concerné. Cette décision ne saurait engager la responsabilité des Éditeurs à l\'égard de l\'utilisateur sanctionné.',
  ),
];
...
const _article11 = [
  _TosSection(
    ...
    body: 'Conformément au Règlement (UE) 2016/679 du 27 avril 2016 (RGPD) et à la loi n° 78-17 du 6 janvier 1978 modifiée (Loi Informatique et Libertés), les responsables conjoints du traitement des données personnelles sont les deux co-éditeurs de l\'Application, tels qu\'identifiés au Préambule.\n\nPour toute question relative à vos données personnelles : kobeta.app@gmail.com',
  ),
  _TosSection(
    subtitle: '11.2 Données collectées et finalités',
    body: '''Les Éditeurs collectent et traitent les catégories de données suivantes :
  ...
  _TosSection(
    ...
    body: '''Les Éditeurs prennent l'engagement ferme que les données personnelles collectées sont utilisées exclusivement pour les finalités décrites à l'article 11.2. En aucun cas ces données ne sont :
...
Les données d'utilisation collectées à des fins d'amélioration de l'Application sont strictement anonymisées et agrégées avant tout traitement, de sorte qu'elles ne permettent l'identification d'aucun utilisateur.''',
  ...
  _TosSection(
    ...
    body: '''  • Données de compte et de profil : durée de l'activité du compte, puis suppression dans un délai de 30 jours suivant la clôture du compte
  ...
  • Images de profil et logos d'équipe (Cloudinary) : conservées indéfiniment sur les serveurs de Cloudinary. L'utilisateur souhaitant leur suppression devra en faire la demande expressément à kobeta.app@gmail.com
  ...
  _TosSection(
    ...
    body: '''Conformément aux articles 15 à 22 du RGPD, chaque utilisateur dispose des droits suivants :
...
Pour exercer ces droits, l'utilisateur adresse sa demande à : kobeta.app@gmail.com. Les Éditeurs s'engagent à répondre à toute demande dans un délai maximum d'un mois conformément à l'article 12 du RGPD.''',
  ),
  _TosSection(
    subtitle: '11.6 Droit de recours',
    body: 'En cas de réponse insatisfaisante ou d\'absence de réponse, l\'utilisateur dispose du droit d\'introduire une réclamation auprès de la Commission Nationale de l\'Informatique et des Libertés (CNIL), 3 Place de Fontenoy, 75007 Paris — www.cnil.fr.',
  ),
];

const _article12 = [
  _TosSection(
    body: 'L\'Application intègre une fonctionnalité de cartographie permettant de localiser des centres sportifs à proximité de l\'utilisateur. Cette fonctionnalité est fournie via l\'API Google Maps, soumise aux conditions d\'utilisation de Google LLC.\n\nLes Éditeurs ne garantissent pas l\'exactitude, l\'exhaustivité ou la mise à jour des informations relatives aux centres référencés. Le référencement d\'un centre dans l\'Application ne vaut pas recommandation, partenariat commercial ou garantie de la qualité des installations. Les Éditeurs ne sont en aucun cas responsables des informations erronées affichées par le service de cartographie.\n\nLa localisation de l\'utilisateur n\'est utilisée qu\'avec son consentement explicite et uniquement pour afficher les centres à proximité. Elle n\'est pas stockée ni conservée par les Éditeurs.',
  ),
];
